...
void assistirGravacaoAula(tipoAulasAssistidas vAulasAssistidas[], tipoUc vetorUc[], tipoEstudante vEstudante[], int numTotalEstudantes, tipoAula vAulas[], int numTotalAulas, char designacaoAula[], int *numTotalGravacoesAssistidas, int *numAulasGravacoesAssistidas, int numTotalAulasAssistidas, int numTotalUc);
